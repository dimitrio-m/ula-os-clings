...
int main() {
    ...
    //sizeof me da el tamaño de cualquier array en bytes, pero no la cantidade de elementos, entonces
    //divido el total de bytes de todo el arreglo entre el numero de bytes de cada elemento :D
